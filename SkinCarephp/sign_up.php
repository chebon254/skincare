                ...
                <div class="form">
                    <form action="sign_up.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input style="padding: 10px 0px 10px 40px;" class="form-control" type="file" name="image" accept="image/jpg, image/jpeg, image/png" required autocomplete="off">
                        </div>
                        <div class="col form-group">
                            <i class="fa-solid fa-user"></i>
                            <label class="form-label">User Name</label> <br>
                            <input type="text" name="name" class="form-control" placeholder="Last name" aria-label="Enter Last name" required autocomplete="off">
                        </div>
                        <div class="form-group">
                          <i class="fa-solid fa-envelope"></i>
                          <label class="form-label">Email</label> <br>
                          <input type="email" name="email" placeholder="enter email" class="form-control" id="inputEmail4" required autocomplete="off">
                        </div>
                        <div class="form-group">
                          <label class="form-label">Password</label> <br>
                          <input type="password" class="form-control" name="password" placeholder="Enter Password" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                          <i class="fa-solid fa-lock"></i>
                        </div>
                        <div class="form-group">
                          <label class="form-label">Re-password</label> <br>
                          <input type="password" name="cpassword" placeholder="confirm password" class="form-control" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                          <i class="fa-solid fa-lock"></i>
                        </div>
                        <div class="col-12">
