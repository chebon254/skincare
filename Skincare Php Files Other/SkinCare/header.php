...
<?php echo $before_head; ?>
    ...
    <meta property="og:image" content="https://skincare-is-project.web.app/assets/img/facebook.png" />
    <meta property="og:type" content="website" />
    ...
    <meta name="twitter:image" content="https://skincare-is-project.web.app/assets/img/twitter.png">
...
<header class="header-scroll header">
            <nav id="nav-bar">
                <div class="nav-container container">
                    <!-- == Logo == -->
                        <div class="logo">
                            <a href="index.php"><img src="assets/img/Skin care logo.png" alt="Skincare Logo"></a>
                        </div>
                            ...
                            <!-- == Product Listing == -->
                                <div class="nav-prod-listing">
                                    <div class="cart nav-listings">
                                        <span class="cart-listings listing" style="cursor: pointer !important;" title="Go To Cart" onclick="location.href='cart.php'"><i class="fas fa-solid fa-shopping-bag"></i><span class="count">
										<?php
										if(!empty($_SESSION["cart_p_id"])) {
											$cart_count = count(array_keys($_SESSION["cart_p_id"]));
										} else{
											$cart_count = '0';
										}
										?>
                                    ...
                                    <div class="account" style="padding-left: 20px;">
										...
										if(isset($_SESSION['customer'])) {
											?>
											<div class="dropdown">
                                                    <button class="dropbtn color"><img style="height: 40px; width: 40px; border-radius: 20px;" src="assets/img/avatar.png"></button>
                                                    <div class="drop">
                                                        <span>Hi, <?php echo $_SESSION['customer']['cust_name']; ?></span>
											...
											<div class="account-access">
												<a href="login.php"><?php echo LANG_VALUE_9; ?></a>
												<span>|</span>
												<a href="registration.php"><?php echo LANG_VALUE_15; ?></a>
											</div>
											<?php	
										}
										?>
